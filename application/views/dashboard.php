        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                    <span class="mr-2">
                        <i class="fas fa-circle text-primary"></i> Penambahan
                    </span>
                    <span class="mr-2">
                        <i class="fas fa-circle text-danger"></i> Pengambilan
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="card shadow mb-4">
            <div class="card-header bg-success py-3">
                <h6 class="m-0 font-weight-bold text-white text-center">5 Transaksi Terakhir Penambahan</h6>
            </div>
            <div class="table-responsive">
